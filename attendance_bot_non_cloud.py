...
highpassword = ''  #superadmin password
# Keep in mind - all times in the bot now correspond to local machine values.
# Heroku cloud service uses UTC time - so all time values have to be offset by 8 hours,
# sometimes even requiring schedule dates to be changed.
starttime = '07:30'  # string to denote time to activate autoattendance, 24H clock in format 'HH:MM'
endtime = '12:00'  #string to denote time to deactivate autoattendance, 24H clock in format 'HH:MM'
database = '' #this will be the name of the database file in the system
ranks = [
    'COL', 'SLTC', 'LTC',
    'MAJ', 'CPT', 'LTA',
    'ME4', 'ME3', 'ME2',
